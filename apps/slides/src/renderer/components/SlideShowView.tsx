...
import type { RenderNode, RenderSlide, ShapeRenderNode } from '@prismoffice/pptx-render'
...
function ShowMediaLayer({
  ...
  const nodes = slide.nodes.filter(
    (n): n is import('@prismoffice/pptx-render').PictureRenderNode =>
      n.type === 'picture' && !!(n as import('@prismoffice/pptx-render').PictureRenderNode).media,
  )
